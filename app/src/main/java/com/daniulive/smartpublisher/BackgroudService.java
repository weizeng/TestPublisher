...
// * BackgroudService
// *
// * Github: https://github.com/weizeng/SmarterStreaming
// *
// * Copyright © 2014~2020 weizeng. All rights reserved.
// */
//
...
//        Log.i(TAG, "onStart..");
//
//        pushType = intent.getExtras().getInt(MonitorParamsKey.pushType);
//        videoWidth = intent.getExtras().getInt(MonitorParamsKey.camerawidth);
//        videoHight = intent.getExtras().getInt(MonitorParamsKey.cameraheight);
//        screenResolution = intent.getExtras().getInt(MonitorParamsKey.screenresolution);
...
//
//            boolean isHwEncoder = intent.getExtras().getBoolean(MonitorParamsKey.hwencoder);
//
//            if (isHwEncoder) {
...
//            }
//
//            is_need_local_recorder = intent.getExtras().getBoolean(MonitorParamsKey.recorder);
//
//            ConfigRecorderFuntion();
//
//            String publishURL = intent.getStringExtra(MonitorParamsKey.publishurl);
//
...
//                        data.length, currentCameraType, 0);//currentOrigentation changed by leo. 图像是颠倒的，此处bug
//            }
