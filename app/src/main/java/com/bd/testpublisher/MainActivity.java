...
import com.daniulive.smartpublisher.MonitorParamsKey;
...
//					printText = "URL:" + publishURL;
					publishURL = "rtmp://pili-publish.bearya.com/family/stream_b";
					Log.i(TAG, printText);

					textCurURL = (TextView) findViewById(R.id.txtCurURL);
					textCurURL.setText(printText);

					intent.putExtra(MonitorParamsKey.publishurl, publishURL);

					intent.putExtra(MonitorParamsKey.recorder, is_need_local_recorder);
					intent.putExtra(MonitorParamsKey.hwencoder, is_hardware_encoder);
					intent.putExtra(MonitorParamsKey.switchcamera, isCameraFaceFront);
